...
REGISTER_MESSAGE_NAME(MSG_KeyDown)
REGISTER_MESSAGE_NAME(MSG_KeyUp)
REGISTER_MESSAGE_NAME(MSG_CollideEnv)
REGISTER_MESSAGE_NAME(MSG_CollideMoby)
REGISTER_MESSAGE_NAME(MSG_PlaySound)
REGISTER_MESSAGE_NAME(MSG_LeaderSpeedChanged)
REGISTER_MESSAGE_NAME(MSG_LeaderDirChanged)
